...
class Aset extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->data['rfasilitas'] = $this->m_ref_fas->findAll();
                    ...
                    if ($imagefile = $this->request->getFiles()) {
                        ...
                        foreach ($imagefile['image'] as $img) {
                            if ($img->isValid() && !$img->hasMoved()) {
                                ...
                                // $insertImg = $this->m_aset->update($lastID, ["imag" . $no++ => $newName]);
                                $insertImg ? $img->move($dir, $newName) : NULL;
                            }
                        }
                    }
                    return redirect()->to('aset/index')->with('success', 'Registrasi Aset berhasil!');
                }
            } else {
    ...
    public function detail()
    {
        ...
        // $fasilitas = $this->m_fasilitas->where('kdaset', $aset['kdaset'])->first();
        if (!$aset) {
