...
class TransactionModel extends Model
{
    ...
    protected $allowedFields = [
        'tgltrn', 'drak', 'drtype', 'dnama', 'dnorek',
        'crak', 'crtype', 'cnama', 'cnorek',
        'nominal', 'terbilang', 'ket',
        'multi', 'nominal_cr', 'nominal_dr',
        'created_by', 'updated_by',
        'created_at', 'updated_at', 'deleted_at'
    ];

    protected $column_order = [null, 'tgltrn', 'dnama', 'cnama', 'nominal'];
